...
<b><?php echo $category_title;?></b></a>
	...
	<div id="botPagination">			
		<div style="font-size:90%;margin-top:8px;text-align:center">
			...
			<a href="index.php?p=<?php echo $prev_page?>&amp;catid=<?php echo $randID?>">&laquo; <?php echo $lang_prev?></a>
			</span>
			-
			<?php } ?>
			<?php if ( $next_page != 0 ) { ?>
			<span style="padding:0px 3px">
			<a href="index.php?p=<?php echo $next_page?>&amp;catid=<?php echo $randID?>"><?php echo $lang_next?> &raquo;</a>
			</span>
			<?php }?>
