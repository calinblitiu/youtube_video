...
if ( !$is_logged ){
  ...
  if ( $aConfig["ADMIN_DEMO"] ) {
	echo "<div style=\"color:red;\">Not available on DEMO mode!</div>";
	exit(0);
  }
...
//strip quotes if they set
 ...
 //get initial values
 $SQLq=( isset($_REQUEST['q']) ? trim($_REQUEST['q']) : 'show tables');
 $page=$_REQUEST['p']+0;
...
<br/>";
 ...
 if ($is_sht) $headers.="<th>show create table</th><th>explain</th><th>indexes</th><th>truncate</th><th>optimize</th><th>repair</th>";
