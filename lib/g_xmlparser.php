 ...
 */
    ...
    function GetData() {
      return $this->params; 
		...
		$request = file_get_contents( '../cache/xml/2e63317600de79a13dc69000603aba66.txt');
        $xml_parser = new gc_xmlparser($request);
        $xml_parser->root = $xml_parser->GetRoot();
        $xml_parser->data = $xml_parser->GetData();
        
        
//echo '<pre>';print_r($xml_parser->data);
?>
