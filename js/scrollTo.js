...
ScrollWin.containerName = "vs_container"; // The id name of the div containing the content
ScrollWin.anchorName    = "";  // The alpha portion of the anchor names
ScrollWin.blockName     = "";     // The alpha portion of the content blocks
ScrollWin.onClassName   = "activeDiv";    // The CSS class name for the 'on' state
ScrollWin.offClassName  = "visitedDiv";   // The CSS class name for the 'off' state