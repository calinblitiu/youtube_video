...
$data_videos   				= YT_GetUserUpload($_GET['u'], 1, $config['user_uploaded_list_per_page']);
$total_user_upload_videos	= YT_Total_Videos($data_videos);
$user_upload_videos			= YT_Videos($data_videos);

$data_videos	 			= YT_GetUserFavorites($_GET['u'], 1, $config['user_favorites_list_per_page']);
$total_user_fav_videos		= YT_Total_Videos($data_videos);
$user_fav_videos			= YT_Videos($data_videos, 'user_favorites');
...
$tpl->assign('favorites_count', $total_user_fav_videos);
$tpl->assign('contacts_count', $contacts_count);
$tpl->assign('subscriptions_count', $subscriptions_count);

$tpl->assign('upload_count', $total_user_upload_videos);
$tpl->assign('user_upload', $user_upload_videos);
$tpl->assign('user_favorites', $user_fav_videos);
$tpl->assign('total',ceil($total_user_upload_videos / $config['list_per_page']));
